    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(236,72,153,0.12),_transparent_35%),_linear-gradient(180deg,_rgb(15_23_42)_0%,_rgb(15_23_42)_100%)] text-slate-100">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-20 sm:px-8">
        <section className="grid gap-12 py-16 lg:grid-cols-[1.3fr_0.7fr] lg:items-center">
          ...
          <div className="rounded-[2rem] border border-slate-700/70 bg-slate-900/70 p-8 shadow-soft backdrop-blur-lg">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <h2 className="text-2xl font-semibold text-white">Creative dashboard UI</h2>
                <p className="text-slate-300">A React dashboard built with reusable components, responsive layouts, and accessible interactions.</p>
              </div>
            </div>
          </div>
        </section>

        <section id="about" className="space-y-6 rounded-[2rem] border border-slate-800/80 bg-slate-900/70 p-8 shadow-soft backdrop-blur-lg">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-3xl bg-slate-950/80 p-6">
              ...
              <p className="mt-2 text-slate-400">Component libraries, single-page apps, interactive design systems, and performance-minded front-end architecture.</p>
            </div>
            <div className="rounded-3xl bg-slate-950/80 p-6">
              <p className="text-lg font-semibold text-white">Approach</p>
              <p className="mt-2 text-slate-400">Clean code, strong collaboration with designers, accessible patterns, and a mobile-first mindset.</p>
            </div>
          </div>
        </section>
        ...
        <section id="skills" className="rounded-[2rem] border border-slate-800/80 bg-slate-900/70 p-8 shadow-soft backdrop-blur-lg">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {['React', 'Tailwind CSS', 'JavaScript', 'HTML/CSS', 'Responsive Design', 'Accessibility'].map(skill => (
              <div key={skill} className="rounded-3xl bg-slate-950/80 px-5 py-4 text-center text-slate-200">
                {skill}
              </div>
            ))}
          </div>
